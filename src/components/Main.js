...
function Main({ onEditProfile, onAddPlace, onCardDelete, onEditAvatar, onCardLike, onCardClick }) {

   const translationUserData = useContext(CurrentUserContext);
   const translationDataCards = useContext(CardsDataContext);
      ...
      <main className="content">
         <section className="profile">
            <div className="profile__info">
               <div className="profile__conteiner-avatar">
                  <img alt="Аватарка" className="profile__avatar" src={translationUserData.avatar}></img>
         ...
         <div className="photo">
            <ul className="photo__container">
               {translationDataCards.map((element) => {
                  return (
                     <Card key={element._id} onCardDelete={onCardDelete} onCardLike={onCardLike} onCardClick={onCardClick} card={element} />
                  );
               })}
            </ul>
         </div>
